...
.PHONY: help install dev dev-web build start kioskpi prisma-generate prisma-migrate db-seed docker-build docker-up docker-down docker-logs launch check-api docker-toggle docker-publish-latest docker-release
